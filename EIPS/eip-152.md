...
| --- | --- | --- | --- | --- | --- | --- |
|  Tjaden Hess, Matt Luongo  , Piotr Dyraga, James Hancock |  [issues-152](https://github.com/ethereum/EIPs/issues/152) | Final | Standards Track | Core |  2016-10-04 | 2019-05-19 | [2046](eip-2046.md) |
...
EIP152 引入了一个新的预编译合约，该合约实现了BLAKE2 哈希算法中使用的压缩函数 `F`，目的是让 EVM和 Zcash 之间相互交互，并将更灵活的加密哈希原语引入到EVM。
