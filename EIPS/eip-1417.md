...
3. Allow the compatibility with token standard such as [ERC-20](eip-20.html) or (eip-20.html)) and membership standard such as [EIP-1261](eip-20.html)
