...
1. **Attempt calling a URI** if the app supports [URL format for transaction requests EIP](eip-681.html) then attempt calling this. This can be automatic or prompted by user action.
