# EIP 197 : 在椭圆曲线alt_bn128上进行最佳配对检查的预编译合约

| 作者 | 状态 | 类型 | 分类 | 创建时间 |
| --- | --- | --- | --- | --- | --- |
| Vitalik Buterin <vitalik@ethereum.org>, Christian Reitwiessner <chris@ethereum.org> | 最终 |  Standards Track |  Core | 2017-02-06 |
