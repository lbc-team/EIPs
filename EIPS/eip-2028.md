# EIP 2028 : 降低交易参数数据（Calldata）的gas消耗

| 作者 | 讨论 |  类型 | 分类 | 状态 | 创建时间 |
| --- | --- | --- | --- | --- | --- |
| Alexey Akhunov (@AlexeyAkhunov), Eli Ben Sasson <eli@starkware.co>, Tom Brand <tom@starkware.co>, Louis Guthmann <louis@starkware.co>, Avihu Levy <avihu@starkware.co> | [3028](https://ethereum-magicians.org/t/eip-2028-calldata-gas-cost-reduction/3280) | Standards Track | Core  | 草稿 | 2019-05-03 |
