...
If we use for instance this resolver profile defined in [EIP634](eip-634.html) which permits the lookup of arbitrary key-value text data, we can for instance use the key `url` to point to a website. 
...
[EIP1581: Non-wallet usage of keys derived from BIP32 trees](eip-1581.html)
...
* [EIP600 Ethereum purpose allocation for Deterministic Wallets](eip-600.html)


* [EIP601 Ethereum hierarchy for deterministic wallets](eip-601.html)

#### Accounts Privacy


### ENS
* [EIP137:  Ethereum Domain Name Service - specification](eip-137.html)

* [EIP165: Standard Interface Detection](eip-165.html)

* [EIP634: Storage of text record in ENS](eip-634.html)
...
* [EIP1102: Opt-in account exposure](eip-1102.html)

* [EIP1581: Non-wallet usage of keys derived from BIP-32 trees](eip-1581.html)
