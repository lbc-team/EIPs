...
`EXTCODEHASH` was introduced in Constantinople, with [EIP-1052](eip-1052.html). It was priced at `400` with the reasoning:
...
- Contracts that assume a certain fixed gas cost for calls (or internal sections) may cease to function.
  - A fixed gas cost is specified in [ERC-165](eip-165.html) and implementations of this interface do use the affected opcodes.
...
[eip-150]: https://learnblockchain.cn/docs/eips/eip-150.html
