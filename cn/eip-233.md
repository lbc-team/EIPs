...
A template for the [Istanbul Hardfork Meta 1679](eip-1679.html) is included below ([source file on Github](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1679.md)):
