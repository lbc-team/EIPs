...
## 简要说明
An extension of the [ERC721 standard](eip-721.html) to enable ERC721 tokens to own other ERC721 tokens and ERC20 tokens.

An extension of the [ERC20](eip-20.html) and [ERC223](https://github.com/ethereum/EIPs/issues/223) standards to enable ERC20 and ERC223 tokens to be owned by ERC721 tokens.
...
ERC998ERC721 top-down, ERC998ERC20 top-down, and ERC998ERC721 bottom-up composable contracts must implement the [ERC721 interface](eip-721.html).

### ERC20

ERC998ERC20 bottom-up composable contracts must implement the [ERC20 interface](eip-20.html).

### ERC165

The [ERC165 standard](eip-165.html) must be applied to each ERC998 interface that is used.
