...
| --- | --- | --- | --- | --- | --- | --- |
|Jordi Baylina, Jacques Dafflon|  Final | Standards Track| ERC | 165, 214 |  2019-03-04 | [820](eip-820.md) |
...
/// @notice For more details, see heip-1820
...
```
{
        ...
        "output": {
          ...
          "userdoc": {
            ...
            "notice": "This contract is the official implementation of the ERC1820 Registry.For more details, see heip-1820"
          }
        },
        "settings": {
          "compilationTarget": {
...
[EIP155]: eip-155.md
[ERC165]: eip-165.md
[ERC672]: https://github.com/ethereum/EIPs/issues/672.md
[ERC820]: eip-820.md
[ERC1820]: eip-1820.md
