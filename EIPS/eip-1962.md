...
This proposal is an extension and formalization of [EIP1829](eip-1829.html) with an inclusion of pairings. [EIP1109](eip-1829.html) is required due to low cost of some operations compared to the `STATICCALL` opcode (more information in the corresponding section below).
...
- There is a pending proposal to implement base elliptic curve arithmetic is covered by [EIP1829](eip-1829.html) and will allow to implement various privacy-preserving protocols with a reasonable gas costs per operation.
...
Functionality of this newly proposed precompile is different from [EIP1829](eip-1829.html) in the following aspects:
