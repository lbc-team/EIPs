...
4. Allow the compatibility with token standard such as [ERC-20](eip-20.html) or other new standards([EIP-777](eip-777.html)) and item standard such as [EIP-721](eip-721.html)
5. Create massive potential for interoperability within Ethereum echo systems and other system.
6. Allow setting voting deadline, allow determine on single or multiple options. Allow requiring voting orders. (trade-off is interface complexity, we might need [ERC-20](eip-20.html) approach and later a [EIP-777](eip-777.html) for advanced voting)
...
2. Determine on creating new item under [EIP-721](eip-721.html)
...
### 示例 1: Simplest Version: Single Issue Yes/No Question Per Smart Contract Address Per Non-Weighted Vote
...
### 示例 2: TokenVote with Simple Interface with Weight Assigned by Token and Pre-registered Snapshot of Token-Holders
...
### 示例 3: TokenVote with Advanced Interface
...
2. Should each issue have its own smart contract address (like individual item on [EIP-721](eip-721.html)) or should it support multiple items in [EIP-1155](eip-721.html), or should it support multi-class voting in [EIP-1178](eip-721.html), [EIP-1203](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1203.md) (e.g. certain issue can override another issue)
**Answer**: We will provide examples of both and seek comments.

3. Should the voting support proxy(e.g [EIP-897](eip-897.html), [EIP-1167](eip-1167.html)) and migration? What are potential security concerns
...
1. Should it support or optionally support [EIP-165](eip-165.html)? For public voting, support EIP-165 make it easier to discover, but for secret voting people might not want to disclose a voting for certain issue even exist.
**Answer**: It shall not be determined by this ERC.
...
## Bibliography
### Related EIPs
 - [EIP-20: ERC-20 Token Standard (a.k.a. ERC-20)](eip-20.html)
 - [EIP-165: Standard Interface Detection](eip-165.html)
 - [EIP-721: Non-Fungible Token Standard(a.k.a. ERC-721)](eip-721.html)
 ...
 - [EIP-777: A New Advanced Token Standard](eip-777.html)
 - [EIP-897: ERC DelegateProxy](eip-897.html)
 - [EIP-1155: Crypto Item Standard](eip-1155.html)
 - [EIP-1178: Multi-class Token Standard](eip-1178.html)
 - [EIP-1167: Minimal Proxy Contract](eip-1167.html)
