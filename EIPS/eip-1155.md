# EIP 1155: ERC-1155 多代币标准

| 作者 | 讨论 | 状态 | 类型 | 分类 | 创建时间 | 依赖 |
| --- | --- | --- | --- | --- | --- |  --- | --- |
|Witek Radomski 等 | [1155](https://github.com/ethereum/EIPs/issues/1155) | 最终 | Standards Track | ERC | 2018-06-17 | [165](eip-165.md) |
...
The optional `ERC1155Metadata_URI` extension can be identified with the (ERC-165 Standard Interface Detection)[https://learnblockchain.cn/docs/eips/eip-165.html].
...
The function `setApprovalForAll` allows an operator to manage one's entire set of tokens on behalf of the approver. To permit approval of a subset of token IDs, an interface such as [ERC-1761 Scoped Approval Interface](eip-1761.html) is suggested.
...
**Standards**
- [ERC-721 Non-Fungible Token Standard](eip-721.html)
- [ERC-165 Standard Interface Detection](eip-165.html)
- [ERC-1538 Transparent Contract Standard](eip-1538.html)
